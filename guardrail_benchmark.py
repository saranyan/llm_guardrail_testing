...
def generate_html_report(run_dir: str):
    ...
    # 2. Refusal rates by category and model
    ...
    <body>
        ...
        <div class="summary-box">
            ...
            <p><strong>Categories:</strong> {', '.join(categories) if len(categories) > 0 else 'N/A'}</p>
        ...
        <div class="findings-box">
            <h2>Key Findings</h2>
            <ul>
                {findings_html if findings_html else "<li>No significant patterns detected</li>"}
            </ul>
        </div>
        ...
        <table>
            ...
            {category_comparison if category_comparison else "<tr><td colspan='3'>No category data available</td></tr>"}
        </table>
